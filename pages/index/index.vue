		...
		<view class="list-content-box">
			<view class="list-content-box-re">
				<view class="cu-bar bg-my-black" @click="goCateDetail(1)">
					...
					<view class="fr">
						<text class="text-my-white text-sm video-more-text">共{{ hotVideos.count ? hotVideos.count : '-' }}部</text>
					</view>
				</view>
				...
				<view class="cu-bar bg-my-black" @click="goCateDetail(2)">
					...
					<view class="fr">
						<text class="text-my-white text-sm video-more-text">共{{ ihotVideos.count ? ihotVideos.count : '-' }}部</text>
					</view>
				</view>
				<view class="bg-my-black padding-25 ">
					<view class="flex flex-wrap grid col-3 grid-square gundong-box">
				...
				<view class="cu-bar bg-my-black" @click="goCateDetail(3)">
					...
					<view class="fr">
						<text class="text-my-white text-sm video-more-text">共{{ acgViedeos.count ? acgViedeos.count : '-' }}部</text>
					</view>
				</view>
				<view class="bg-my-black padding-25 ">
					<view class="flex flex-wrap grid col-3 grid-square gundong-box">
				...
				<view class="cu-bar bg-my-black" @click="goCateDetail(4)">
					...
					<view class="fr">
						<text class="text-my-white text-sm video-more-text">共{{ varietyViedeos.count ? varietyViedeos.count : '-' }}部</text>
					</view>
				</view>
				<view class="bg-my-black padding-25 ">
					<view class="flex flex-wrap grid col-3 grid-square gundong-box">
